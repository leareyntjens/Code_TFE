...
def transcript_uncertainties(uncer_params, config):
    ...
    # c_op_syn_fuels
    config['all_data']['Resources'].loc['H2_RE', 'c_op'] *= (1. + up['c_op_syn_H2'])
    config['all_data']['Resources'].loc['GAS_RE', 'c_op'] *= (1. + up['c_op_syn_CH4'])
    config['all_data']['Resources'].loc['METHANOL_RE', 'c_op'] *= (1. + up['c_op_syn_methanol'])
    config['all_data']['Resources'].loc['AMMONIA_RE', 'c_op'] *= (1. + up['c_op_syn_ammoniac'])
    # c_op_ hydrocarbons
